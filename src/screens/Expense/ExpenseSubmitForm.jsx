...
import { submitDailyExpense } from "../../store/slice/Expence.slice";
...
const ExpenseSubmitForm = ({ navigation }) => {
    ...
    const loading = useSelector(state => state.expense.loading) || false;
    ...
    const validateForm = () => {
        ...
        if (!form.TotalAmount || Number(form.TotalAmount) <= 0) {
            Toast.show({
                type: "customNotificationError",
                text1: "Enter a valid total amount",
                visibilityTime: 2000
            });
            return false;
        }
    ...
    const handleSubmit = async () => {
        ...
        const res = await dispatch(submitDailyExpense(data))
        if (res.type === "submitDailyExpense/fulfilled" && res.payload[0].Status == "Sucess") {
            Toast.show({
    ...
    return (
        ...
        >
            ...
            >
                ...
                <CustomNavBar
                    navName="Submit Daily Expenses"
                    subtitle="Submit your pending daily expense entries"
                />
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.section}>
                        ...
                        >
                            ...
                            <Icon name="calendar-days" size={17} color="#777" />

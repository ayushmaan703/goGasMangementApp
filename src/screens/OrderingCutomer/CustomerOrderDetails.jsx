...
const CustomerOrderDetails = () => {
    ...
    const [deliveredQuantity, setDeliveredQuantity] = useState(quantity);
    ...
    const handleMarkDone = async () => {
        ...
        if (
            result.type ===
            "customerOrderEntryDone/fulfilled"
        ) {
    ...
    return (
        ...
        <SafeAreaView style={styles.container}>
            ...
            <CustomNavBar
                ...
                subtitle="View your cylinder order"
            />
            ...
            >
                ...
                <View style={styles.card}>
                    ...
                    {complete ?
                        <View style={styles.quantityAdjustmentCard}>
                            ...
                            {/* Optional original quantity reference */}
                ...
                {status == 0 && (
                    ...
                    <View style={styles.actionContainer}>
                        ...
                        {currUser.UserType == "Customer" && < TouchableOpacity

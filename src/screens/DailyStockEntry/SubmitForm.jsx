...
const SubmitForm = ({ navigation }) => {
    ...
    const loading = useSelector(state => state.dailyEntry.loading) || false;
    ...
    const validateForm = () => {
        ...
        if (!form.balanceEmpty) {

            Toast.show({
                type: "customNotificationError",
                text1: "Balance empty is required",
            });
    ...
    const handleSubmit = async () => {
        ...
        const data = {
            ...
            BalanceCyc: form.balanceCyc,
            BalanceEmpty: form.balanceEmpty,
            TotalCash: form.totalCash,
            Comid: comid,
        };

        const res = await dispatch(submitDailyStockEntry(data))
        ...
        >
            ...
            >
                ...
                <CustomNavBar
                    ...
                    subtitle="Submit your pending daily stock entries"
                />
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.section}>
                        ...
                        <InputField
                            ...
                            placeholder="Enter balance empty"
                            keyboardType="numeric"
                        />

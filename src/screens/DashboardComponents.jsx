...
export const StatCard = ({ icon, title, value, subtitle, color = COLORS.blue, bg = COLORS.blueLight, onPress }) => (
  <TouchableOpacity style={styles.statCard} onPress={onPress} activeOpacity={0.82}>
    ...
    {onPress && <FontAwesome6 name="chevron-right" size={12} color="#AAB4C0" />}
  </TouchableOpacity>
);
...
const styles = StyleSheet.create({
  ...
  statCard: { width: "48%", backgroundColor: COLORS.white, borderRadius: 16, borderWidth: 1, borderColor: COLORS.border, padding: 13, minHeight: 125, marginBottom: 10, flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" },
